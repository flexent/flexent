...
- Keep decorators closely aligned with the underlying standard HTTP methods and routing conventions.
- Don't add external runtime dependencies unless absolutely necessary.
